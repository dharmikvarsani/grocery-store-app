...
//             <h1 className='flex justify-center items-center xl:text-2xl text-xl text-white font-bold h-[50px] bg-green-500'>{selectedCategory}</h1>
...
//                 <h1 className='font-bold xl:text-2xl text-xl text-left  text-green-400'>All {selectedCategory} Products</h1>
